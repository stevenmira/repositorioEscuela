...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ route('login')}}" class="logo">
          ...
          <span class="logo-lg"><b href="{{URL::action('HomeController@index')}}">Administraciónes</b></span>
        </a>
        ...
        <section class="sidebar">
         ...
         <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{URL::action('MatriculaController@index')}}"><i class="fa fa-circle-o"></i> Consultar por Curso</a></li>
                <li><a href="{{URL::action('Matricula2Controller@index')}}"><i class="fa fa-circle-o"></i> Consultar por Matricula</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{URL::action('FaltaController@index')}}"><i class="fa fa-circle-o"></i> Agregar Inasistencia</a></li>
                <li><a href="{{URL::action('FaltaController@index2')}}"><i class="fa fa-circle-o"></i> Consultar Asistencia</a></li>
              </ul>
            </li>
            @endif 
    ...
    <script src="{{asset('js/dropAct.js')}}"></script>
