...
{!!Form::model($matricula,['method'=>'PATCH','route'=>['expediente.matricula2.update',$matricula->id_matricula], 'files'=>'true'])!!}
{{Form::token()}}
			...
			<div class="form-group">
				<div class="form-group">
					<div class="col-md-4">
							...
							{!! Form::number('partida', $detallepartida->partida, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Partida...', 'disabled'=>'on']) !!}
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-4">
						<label>N°. Folio partida de nacimiento</label>
						{!! Form::number('folio', $detallepartida->folio, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Folio...', 'autofocus'=>'on', 'disabled'=>'on']) !!}
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-4">
						<label>N°. Libro partida de nacimiento</label>
						{!! Form::number('libro', $detallepartida->libro, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Libro...', 'autofocus'=>'on', 'disabled'=>'on']) !!}
					</div>
				</div>
			</div>
			<br><br><br>
			<div class="form-group">
				...
				<div class="form-group">
					<div class="form-group col-md-4">
						...
						{!! Form::text('nombre', $estudiante->nombre, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca los nombre', 'autofocus'=>'on', 'disabled'=>'on']) !!}
					</div>
				</div>
				<div class="form-group">
					<div class="form-group col-md-4">
						<label for="">Apellidos</label>
						{!! Form::text('apellido', $estudiante->apellido, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduza los apellidos', 'autofocus'=>'on' , 'disabled'=>'on']) !!}
					</div>
				</div>
			</div>
			<br><br><br>
			<div class="form-group">
				<div class="form-group">
					<div class="form-group col-md-4">
						...
						'placeholder'=>'AAAA-MM-DD', 'autofocus'=>'on', 'disabled'=>'on']) !!}
					</div>
				</div>
				<div class="form-group">
					<div class="form-group col-md-4">
						<label>Sexo</label></br>
							@if ($estudiante->sexo == 'F')
								<label>{!! Form::radio('sexo', '1', true, ['disabled'=>'on']) !!} Femenino</label>
								<label>{!! Form::radio('sexo', '0', false, ['disabled'=>'on'])  !!} Masculino</label>
							@else
								<label>{!! Form::radio('sexo', '1', false, ['disabled'=>'on']) !!} Femenino</label>
								<label>{!! Form::radio('sexo', '0', true, ['disabled'=>'on'])  !!} Masculino</label>
							@endif
					</div>
				</div>
				<div class="form-group">
