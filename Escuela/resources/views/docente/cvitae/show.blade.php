    ...
    <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-condensed table-hover">
                                       ...
                                       @foreach ($estudios as $ma)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset('imagenes/maestros/estudios/'.$ma->copia)}}" alt="{{ $ma->copia}}" height="150px" width="150px" class="img-thumbnail" onclick="javascript:this.width=550;this.height=500" ondblclick="javascript:this.width=150;this.height=150">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </table>
                                    ...
                                    <table class="table table-striped table-bordered table-condensed table-hover">
                                       ...
                                       @foreach ($capacitaciones as $ca)
                                        <tr>
                                            ...
                                            <td>{{ $ca->horas }}</td>
                                            <td>
                                                <img src="{{asset('imagenes/maestros/capacitaciones/'.$ca->copia)}}" alt="{{ $ca->copia}}" height="150px" width="150px" class="img-thumbnail" onclick="javascript:this.width=550;this.height=500" ondblclick="javascript:this.width=150;this.height=150">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </table>
                                    ...
                                    <table class="table table-striped table-bordered table-condensed table-hover">
                                       ...
                                       @foreach ($trabajos as $tb)
                                        <tr>
                                            ...
                                            <td>{{ $tb->tiempo }}</td>
                                            <td>
                                                <img src="{{asset('imagenes/maestros/trabajos/'.$tb->copia)}}" alt="{{ $tb->copia}}" height="150px" width="150px" class="img-thumbnail" onclick="javascript:this.width=550;this.height=500" ondblclick="javascript:this.width=150;this.height=150">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </table>
        ...
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="form-group">
                <a href="{{URL::action('HojaVidaController@index')}}" class="btn btn-danger btn-lg col-md-offset-10"><i class="fa fa-chevron-left" aria-hidden="true"></i> Atrás</a>
            </div>
        </div>
    </div>
</fieldset>
