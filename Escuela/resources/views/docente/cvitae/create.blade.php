...
<div class="col-md-12 col-md-offset-0">
	...
	<div class="row">	
		...
		<div class="col-md-12">
			<div class="form-group col-md-3">
				<label>NIP</label>
				{!! Form::number('nip', null, ['class' => 'form-control' ,'placeholder'=>'NIP...',  'required' => 'required',
				 'autofocus'=>'on']) !!}
			</div>
			<div class="form-group col-md-3">
				<label>NIT</label>
		...
		<div class="col-md-12">
			<div class="form-group col-md-3">
				...
				{!! Form::date('extendido', null, ['class' => 'form-control',
				'placeholder'=>'AAAA-MM-DD', 'autofocus'=>'on']) !!}
			</div>
			<div class="form-group col-md-6">
		...
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
			...
			<input name="_token" value="{{csrf_token()}}" type="hidden"></input>
            	...
            	<button class="btn btn-primary col-md-offset-8 btn-lg" type="submit">Guardar</button>
        	</div>
		</div>
