...
<fieldset class="well the-fieldset">
	...
	<div class="row">
		...
		<div class="col-md-12 ">
			...
			<div class="form-group col-md-3">
				<label for="">NIT</label>
				{!! Form::number('nit', $maestro->nit, ['class' => 'form-control', 'placeholder'=>'NIT sin guiones', 'required' => 'required', 'autofocus'=>'on']) !!}
			</div>
			<div class="form-group col-md-3">
				<label for="">NIP</label>
				{!! Form::number('nip', $maestro->nip, ['class' => 'form-control', 'placeholder'=>'NIP...', 'required' => 'required', 'autofocus'=>'on']) !!}
			</div>
			<div class="form-group col-md-3">
				<label for="">AFP</label>
		...
		<div class="col-md-12 ">
			...
			<div class="form-group col-md-3">
				...
				{!! Form::date('extendido', $maestro->extendido, ['class' => 'form-control',
				'placeholder'=>'AAAA-MM-DD', 'autofocus'=>'on']) !!}
			</div>
			<div class="form-group col-md-3">
		...
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
			...
			<input name="_token" value="{{csrf_token()}}" type="hidden"></input>
            	<a href="{{URL::action('HojaVidaController@index')}}" class="btn btn-danger btn-lg col-md-offset-1">Cancelar</a>
