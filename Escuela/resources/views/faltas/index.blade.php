...
<div class="row">
        <div class="col-lg-12">
         ...
         <p>(Puede registrar inasistencia en los siguientes cursos)</p>   
        </div>
    </div>   
  ...
  @foreach($asig_gram as $gram)
            ...
            <a href="{{ url('faltas/lista/estudiante', ['a1' => $gram->id_detalleasignacion]) }}" >
  ...
  @foreach($asig_grav as $grav)
            ...
            <a href="{{ url('faltas/lista/estudiante', ['a1' => $grav->id_detalleasignacion]) }}" >
              <div class="boot col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="div-square col-lg-4 col-md-4 col-sm-4 col-xs-4">
                       <i class="fa fa-list-alt fa-5x"></i>
                @if($grav->nombregrado != "")
